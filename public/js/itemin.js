$(document).ready(function() {
        ...
        $('#search-item').on('select2:select', function(e) {
            ...
            if (!items.includes(id)) {
                ...
                let costPrice = "<td><input type='number' class='form-control cost-price' name='item[" + rowCount + "][cost-price]' id='cost-price-" + rowCount + "' value='" + $(e.params.data.element).data('cost-price') + "'></td>";
