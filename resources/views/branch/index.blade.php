    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {{ Form::text('contact-number', '', ['class' => 'form-control', 'id' => 'contact-number', 'required' => true, 'placeholder' => 'Enter contact number', 'autocomplete' => 'off']) }}
            </div>
            <div class="form-group">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                {{ Form::text('edit-contact-number', '', ['class' => 'form-control', 'id' => 'edit-contact-number', 'required' => true, 'placeholder' => 'Enter contact number', 'autocomplete' => 'off']) }}
            </div>
            <div class="form-group">
            <label for="active">Status</label>
