...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Manage Item In</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <button class="btn btn-primary" data-toggle="modal" data-target="#add-itemin-modal">Add Item In</button>
          <br><br>
          <!-- Default box -->
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Manage Item In</h3>
                </div>
              <div class="card-body">
                ...
                <div class="modal-body">
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" readonly class="form-control-plaintext" id="purchase-number" name="purchase-number" value="{{ $controlNumber }}">
                            </div>
                        </div>
